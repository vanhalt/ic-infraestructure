#!/bin/bash
export resourceGroup=ripleyRG
virtualMachine=ripleyJenkins
adminUser=vanhalt
pathToKubeConfig=../ripleyk8s
...
# Warning: Permanently added '23.99.224.87' (ECDSA) to the list of known hosts.
# ripleyk8s                                                                                                                                                                                                                                     100% 9484    20.2KB/s   00:00
# Open a browser to http://23.99.224.87:8080
# Enter the following to Unlock Jenkins:
# e465b15fa0d84fd29ad86ea9d2e837fd

# vanhalt:jenkins.com1234